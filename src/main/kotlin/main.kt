...
fun main() {
    ...
    var currentPizzaCity: PizzaMainClass
...
private fun selectPizza(currentPizzaCity: PizzaMainClass) {
...
fun selectAddService(currentPizzaCity: PizzaMainClass, currentPizza: String) {
